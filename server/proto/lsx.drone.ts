...
export const BombBase = {
  encode(message: BombBase, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      BombBase_Request.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    if (message.response !== undefined) {
      BombBase_Response.encode(message.response, writer.uint32(18).fork()).ldelim();
    }
  ...
  fromJSON(object: any): BombBase {
    return {
      request: isSet(object.request) ? BombBase_Request.fromJSON(object.request) : undefined,
      response: isSet(object.response) ? BombBase_Response.fromJSON(object.response) : undefined,
  ...
  toJSON(message: BombBase): unknown {
    const obj: any = {};
    if (message.request !== undefined) {
      obj.request = BombBase_Request.toJSON(message.request);
    }
    if (message.response !== undefined) {
      obj.response = BombBase_Response.toJSON(message.response);
    }
    if (message.error !== undefined) {
...
export const BombArea = {
  encode(message: BombArea, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      BombArea_Request.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    if (message.response !== undefined) {
      BombArea_Response.encode(message.response, writer.uint32(18).fork()).ldelim();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
  ...
  fromJSON(object: any): BombArea {
    return {
      request: isSet(object.request) ? BombArea_Request.fromJSON(object.request) : undefined,
      response: isSet(object.response) ? BombArea_Response.fromJSON(object.response) : undefined,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  },
  ...
  toJSON(message: BombArea): unknown {
    const obj: any = {};
    if (message.request !== undefined) {
      obj.request = BombArea_Request.toJSON(message.request);
    }
    if (message.response !== undefined) {
      obj.response = BombArea_Response.toJSON(message.response);
    }
    if (message.error !== undefined) {
      obj.error = message.error;
    }
...
export const GetBombAreaState = {
  encode(message: GetBombAreaState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      GetBombAreaState_Request.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    if (message.response !== undefined) {
      GetBombAreaState_Response.encode(message.response, writer.uint32(18).fork()).ldelim();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.request = GetBombAreaState_Request.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.response = GetBombAreaState_Response.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): GetBombAreaState {
    return {
      request: isSet(object.request) ? GetBombAreaState_Request.fromJSON(object.request) : undefined,
      response: isSet(object.response) ? GetBombAreaState_Response.fromJSON(object.response) : undefined,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  },
  ...
  toJSON(message: GetBombAreaState): unknown {
    const obj: any = {};
    if (message.request !== undefined) {
      obj.request = GetBombAreaState_Request.toJSON(message.request);
    }
    if (message.response !== undefined) {
      obj.response = GetBombAreaState_Response.toJSON(message.response);
    }
    if (message.error !== undefined) {
      obj.error = message.error;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GetBombAreaState>, I>>(object: I): GetBombAreaState {
    const message = createBaseGetBombAreaState();
    message.request = (object.request !== undefined && object.request !== null)
...
export const GetModeSilentState = {
  encode(message: GetModeSilentState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      GetModeSilentState_Request.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    if (message.response !== undefined) {
      GetModeSilentState_Response.encode(message.response, writer.uint32(18).fork()).ldelim();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.request = GetModeSilentState_Request.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.response = GetModeSilentState_Response.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): GetModeSilentState {
    return {
      request: isSet(object.request) ? GetModeSilentState_Request.fromJSON(object.request) : undefined,
      response: isSet(object.response) ? GetModeSilentState_Response.fromJSON(object.response) : undefined,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  },
  ...
  toJSON(message: GetModeSilentState): unknown {
    const obj: any = {};
    if (message.request !== undefined) {
      obj.request = GetModeSilentState_Request.toJSON(message.request);
    }
    if (message.response !== undefined) {
      obj.response = GetModeSilentState_Response.toJSON(message.response);
    }
    if (message.error !== undefined) {
      obj.error = message.error;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GetModeSilentState>, I>>(object: I): GetModeSilentState {
    const message = createBaseGetModeSilentState();
    message.request = (object.request !== undefined && object.request !== null)
...
export const SetModeSilentState = {
  encode(message: SetModeSilentState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.request !== undefined) {
      SetModeSilentState_Request.encode(message.request, writer.uint32(10).fork()).ldelim();
    }
    if (message.response !== undefined) {
      SetModeSilentState_Response.encode(message.response, writer.uint32(18).fork()).ldelim();
    }
    if (message.error !== undefined) {
      writer.uint32(26).string(message.error);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.request = SetModeSilentState_Request.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.response = SetModeSilentState_Response.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): SetModeSilentState {
    return {
      request: isSet(object.request) ? SetModeSilentState_Request.fromJSON(object.request) : undefined,
      response: isSet(object.response) ? SetModeSilentState_Response.fromJSON(object.response) : undefined,
      error: isSet(object.error) ? globalThis.String(object.error) : undefined,
    };
  },
  ...
  toJSON(message: SetModeSilentState): unknown {
    const obj: any = {};
    if (message.request !== undefined) {
      obj.request = SetModeSilentState_Request.toJSON(message.request);
    }
    if (message.response !== undefined) {
      obj.response = SetModeSilentState_Response.toJSON(message.response);
    }
    if (message.error !== undefined) {
      obj.error = message.error;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<SetModeSilentState>, I>>(object: I): SetModeSilentState {
    const message = createBaseSetModeSilentState();
    message.request = (object.request !== undefined && object.request !== null)
